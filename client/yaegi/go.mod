...
require (
	...
	github.com/go-plugify/go-plugify v0.0.0-20251107094212-247a0d84f2d7 // indirect
	github.com/go-plugify/webadapters v0.0.0-20251031234012-4e33d72ddc53 // indirect
